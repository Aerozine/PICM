...
void PIC::traceParticleU(const int i, const int j, varType &x,
                                    varType &y) const {
...
void PIC::traceParticleV(const int i, const int j, varType &x,
                                    varType &y) const {
...
void PIC::getVelocity(const varType x, const varType y, varType &u,
                                 varType &v) const {
  u = interpolateU(x, y);
  v = interpolateV(x, y);
}

varType PIC::interpolateSmoke(const varType x, const varType y) const {
